...
class ConstructionType(Base):
	__tablename__ = "tbl_construction_type"

	id_construction_type = Column(String(36), primary_key=True)
	...
	def __init__(self, id_construction_type, id_language_content):
		self.id_construction_type = id_construction_type
