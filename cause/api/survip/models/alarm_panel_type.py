...
class AlarmPanelType(Base):
	__tablename__ = "tbl_alarm_panel_type"

	id_alarm_panel_type = Column(String(36), primary_key=True)
	...
	def __init__(self, id_alarm_panel_type, id_language_content):
		self.id_alarm_panel_type = id_alarm_panel_type
