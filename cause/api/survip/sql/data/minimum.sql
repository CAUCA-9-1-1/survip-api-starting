-- Add webuser "admin"
INSERT INTO public.tbl_webuser (id_webuser, username, password, is_active, created_on) VALUES
...
INSERT INTO public.tbl_webuser_attributes (id_webuser, attribute_name, attribute_value) VALUES
  ('d25a7a30-22e0-4169-95b8-bd36368f12d6', 'last_name', 'Cauca'),
  ('d25a7a30-22e0-4169-95b8-bd36368f12d6', 'reset_password', 'false'),
  ('d25a7a30-22e0-4169-95b8-bd36368f12d6', 'first_name', 'Admin');

-- Add all basic permission
INSERT INTO public.tbl_permission_system (id_permission_system, description) VALUES
  ('2d9f85c6-c41b-4b53-b391-9caa31bb3494', 'SURVI-Prevention');

INSERT INTO public.tbl_permission_system_feature (id_permission_system_feature, id_permission_system, feature_name, description, default_value) VALUES
...
INSERT INTO public.tbl_permission_object (id_permission_object, id_permission_object_parent, object_table, generic_id, id_permission_system, is_group, group_name) VALUES
...
INSERT INTO public.tbl_permission (id_permission, id_permission_object, id_permission_system, id_permission_system_feature, created_on, comments, access) VALUES
