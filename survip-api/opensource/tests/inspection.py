...
from opensource.resturls.inspection import Inspection
...
class TestInspection(unittest.TestCase):
	...
	def test_01_insert(self):
		...
		self.assertEqual(result['message'], "inspection successfully assigned")
	...
	def test_03_complete(self):
		...
		self.assertEqual(result['message'], "inspection successfully completed")
